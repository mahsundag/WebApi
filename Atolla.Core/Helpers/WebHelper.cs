...
namespace Atolla.Core.Helpers
{
    public class WebHelper : IWebHelper
    {
        ...
        private readonly Config _hostingConfig;
        private readonly IActionContextAccessor _actionContextAccessor;
        private readonly IApplicationLifetime _applicationLifetime;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IAtollaFileProvider _fileProvider;
        private readonly IUrlHelperFactory _urlHelperFactory;


        public WebHelper(Config hostingConfig,
            IActionContextAccessor actionContextAccessor,
            IApplicationLifetime applicationLifetime,
            IHttpContextAccessor httpContextAccessor,
            IAtollaFileProvider fileProvider,
        ...
        public virtual string GetStoreLocation(bool? useSsl = null)
        {
            ...
            if (string.IsNullOrEmpty(storeHost))
            {
                ...
                storeLocation = "";//EngineContext.Current.Resolve<IStoreContext>().CurrentStore?.Url ?? throw new Exception("Current store cannot be loaded");
            }
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false)
        {
            ...
            if (!success)
            {
                throw new AtollaException("Atolla needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
